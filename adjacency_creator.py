...
for i in range(3):
    for j in range(3):
        display_window = cv2.rectangle(display_window,(412+50+i*200,100+j*200),(412+50+i*200+200,100+j*200+200),(255,0,0),5)
        if(i==1 and j==1):
            display_window[100+j*200:100+j*200+200,412+50+i*200:412+50+i*200+200] = cv2.resize(input_img,(200,200))
